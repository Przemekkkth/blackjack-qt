...
{
    m_buttonPixmap = PixmapManager::Instance()->getPixmap(PixmapManager::TextureID::button);
    m_buttonPixmap = m_buttonPixmap.scaled(300, 70);
    m_pressedButtonPixmap = PixmapManager::Instance()->getPixmap(PixmapManager::TextureID::pressed_button);
